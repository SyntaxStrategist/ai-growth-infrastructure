...
// Dynamic imports to match real dashboard (but with demo data)
...
export default function DemoClientDashboard() {
  ...
  const t = {
    ...
    actions: {
      ...
      disabled: isFrench ? '(Désactivé en mode démo)' : '(Disabled in demo mode)',
    },
    footer: {
      demo: isFrench 
  ...
  // Demo Dashboard UI (Exact Mirror of Real Dashboard)
  return (
    <div className="min-h-screen p-8 bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* AI Insights Components (with demo client ID) */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          className="mb-8"
        >
          <GrowthCopilot locale={locale} clientId="demo-client-id" />
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <ActivityLog locale={locale} clientId="demo-client-id" />
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <PredictiveGrowthEngine locale={locale} clientId="demo-client-id" />
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <RelationshipInsights locale={locale} clientId="demo-client-id" />
        </motion.div>
