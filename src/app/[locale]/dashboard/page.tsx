        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="px-4 py-2 rounded-lg bg-teal-500/20 border border-teal-500/40 text-teal-400 hover:bg-teal-500/30 transition-all duration-300 text-sm font-medium"
            >
